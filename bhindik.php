...
<html class="no-js" lang="en">
    <head>
        ...
        <title>My Practice Texts Bigner hindi kurtidev - Gayatricomputers</title>
...
<div id="sidebar-md-lg" class="sidebar col-md-12 col-lg-2 visible-md visible-lg "  style="background-color:#DC143C;">
    ...
    <div class="list-group" style="font-size:15px;">
		...
		<a href="bhindik.php" class="list-group-item active "  >&nbsp;<i class="fa fa-trophy"></i>&nbsp; <strong>Beginner in Hindi (kurtidev)</strong></br><small>Take a Test</small> </a>
...
$selectquery="select * from  typingtest where language=7 order by id ASC LIMIT $start_from, $limit  ";
...
$result_db = mysqli_query($con,"SELECT COUNT(id) FROM typingtest where language=7"); 
